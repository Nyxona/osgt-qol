...
DEFINE_GAME_FUNCTION(CreateSlider, __fastcall, EntityComponent*, Entity* pBG, float x, float y, float sizeX,
                     std::string buttonFileName, std::string left, std::string middle, std::string right, std::string,
                     std::string, std::string, std::string);
DEFINE_GAME_FUNCTION(CreateCheckBox, __fastcall, Entity*, Entity* pBG, std::string name, std::string text, float x,
                     float y, bool bChecked, uint32_t fontID, float fontScale, bool unclickable, std::string unk10,
                     std::string unk11, std::string unk12)
DEFINE_GAME_FUNCTION(CreateTextButtonEntity, __fastcall, Entity*, Entity* pParentEnt, std::string name, float x,
                     float y, std::string text, bool bUnderline, int unk7, std::string unk8, bool unk9,
...
DEFINE_GAME_FUNCTION(MessageManagerCallEntityFunction, __fastcall, void, void*, Entity*, int, std::string, VariantList*,
                     int);
...
DEFINE_GAME_FUNCTION(SurfaceAnimBlitScaledAnim, __thiscall, void, void* pAnimSurf, float x, float y, int frameX,
                     int frameY, CL_Vec2f* vScale, int alignment, unsigned int rgba, float rotation,
...
DEFINE_GAME_FUNCTION(CreateTextLabelEntity, __fastcall, Entity*, Entity* pParentEnt, std::string name, float vPosX,
                     float vPosY, std::string);
DEFINE_GAME_FUNCTION(SetupTextEntity, __fastcall, void, Entity*, uint32_t eFontID, float fontScale);
DEFINE_GAME_FUNCTION(GetFontAndScaleToFitThisLinesPerScreenY, __fastcall, void, uint32_t& fontID, float& fontScale,
                     float lines);
DEFINE_GAME_FUNCTION(AddBMPRectAroundEntity, __fastcall, void, Entity* pEnt, uint32_t col1, uint32_t col2,
                     float padding, bool bUnk, float fontScale, uint32_t fontID, bool bUnk4);
DEFINE_GAME_FUNCTION(FadeInEntity, __fastcall, void, Entity* pEnt, bool bRecursive, int timeMS, int delayMS,
                     float fadeTarget, int timing);
DEFINE_GAME_FUNCTION(MainMenuCreate, __fastcall, void, Entity*, bool);
DEFINE_GAME_FUNCTION(SetupEntityIconFromItem, __fastcall, Entity*, int* ItemID, Entity* ParentEntity,
                     CL_Vec2f* Position, int, bool bDrawBorder);
DEFINE_GAME_FUNCTION(CreateOverlayEntity, __fastcall, Entity*, Entity* pParentEnt, const std::string name,
