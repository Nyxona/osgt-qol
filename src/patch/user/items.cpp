...
REGISTER_GAME_FUNCTION(ItemInfoSerialize,
                       ...
                       __thiscall, void, void* this_, char* pBytes, int* pSeek, bool bLoadFromMem, uint16_t version,
                       bool arg6);

// GetHorseItemTypes
REGISTER_GAME_FUNCTION(GetHorseItemTypes,
...
// GetCarItemTypes
REGISTER_GAME_FUNCTION(GetCarItemTypes,
                       "40 55 48 8B EC 48 83 EC 20 65 48 8B 04 25 58 00 00 00 8B ? ? ? ? ? BA 08 00 00 00 48 8B 0C C8 "
                       "8B 04 0A 39 ? ? ? ? ? 0F 8F ? ? ? ? 4C 8B ? ? ? ? ? 48 8B ? ? ? ? ? 48 89 5C 24 38 48 89 74 "
...
// NetAvatar::Gravity
REGISTER_GAME_FUNCTION(NetAvatarGravity, "40 53 48 83 EC 70 80 B9 A8 01 00 00 00", __fastcall, void, void* this_);
...
class ItemsDatCrashMeNot : public patch::BasePatch
{
  public:
    void apply() const override
    {
        ...
        game.hookFunctionPatternDirect<ItemInfoSerialize_t>(pattern::ItemInfoSerialize, ItemInfoSerialize,
                                                            &real::ItemInfoSerialize);
    }

    static void __thiscall ItemInfoSerialize(void* this_, char* pBytes, int* pSeek, bool bLoadFromMem, uint16_t version,
                                             bool arg6)
    {
